...
void messTimetableFlow(int isAdmin);
void canteenMenuFlow(int isAdmin);
void submitFeedbackFlow();
void viewFeedbacksFlow();
void clearScreen();
void pause();
...
void studentDashboard() {
    ...
    while(1) {
        ...
        switch(choice) {
            case 1: messTimetableFlow(0); break;
            case 2: canteenMenuFlow(0); break;
            case 3: submitFeedbackFlow(); break;
            case 4: return;
            default: pause();
        }
    }
...
void adminDashboard() {
    ...
    while(1) {
        ...
        switch(choice) {
            case 1: viewFeedbacksFlow(); break;
            case 2: messTimetableFlow(1); break;
            case 3: canteenMenuFlow(1); break;
            case 4: return;
            default: pause();
        }
    }
...
void messTimetableFlow(int isAdmin) {
    ...
    clearScreen();
    //"Mess Timetable" Screen with "Select Day" Dropdown
    printf("\n Mess Timetable \n");
    printf("----------------\n");
    printf(" Select Day:\n");
    for(int i=0; i<7; i++) {
...
void initializeSystem() {
    ...
    if(!fp) {
        ...
        CanteenItem items[] = {
            ...
            {107, "Spring Roll", 75.0, 1},
            {108, "Paneer Parantha", 70.0, 1},
            {109, "Grilled Sandwich", 55.0, 1},
            {110, "Spring Roll", 40.0, 0}, 
